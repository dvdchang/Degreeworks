...
<!-- $Id: //Tuxedo/RELEASE/Product/release/server/admin/xsl/fopaudits.xsl#11 $ -->
...
These images must exist in the admin/images or local/images directory:
dwcheck98.gif
dwcheck99.gif
dwcheckno.gif
dwcheckyes.gif 
...
<!-- CMU Localization === Changed formatting 
<xsl:variable name="vCreditDecimals">0.###</xsl:variable> -->
<xsl:variable name="vCreditDecimals">0.##</xsl:variable> 

<!-- CMU Localization === Added GPA formatting -->
		...
		<fo:static-content flow-name="xsl-region-before">
			...
			<fo:flow flow-name="xsl-region-body">
				...
				<fo:block font-family="sans-serif">
					...
					<!-- CMU Localization === Show disclaimer at the top -->
					...
					<!-- CMU Localization === Do not show disclaimer at the bottom
					<xsl:call-template name="tDisclaimer"/> -->
				</fo:block>
			</fo:flow>
		</fo:page-sequence>
