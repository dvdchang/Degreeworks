--  *************************************************************** 
--         Banner Prereq Request Queue - show messages on CHECK queue
--  $Id$
--  -----------------------------------------------------------------
--  DESCRIPTION:
--  This sql file shows the count of messages waiting on the CHECK request queue
--
--
...
spool preqrequestqshow.out

select count(*) from BANINST1.aq$DW_PREQ_REQUEST_Qtab;
