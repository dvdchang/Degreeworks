--  *************************************************************** 
--         Banner Prereq Request Queue - show messages on DESCR queue
--  $Id$
--  -----------------------------------------------------------------
--  DESCRIPTION:
--  This sql file shows the count of messages waiting on the DESCR request queue
--
--
...
select count(*) from BANINST1.aq$DW_DESC_REQUEST_Qtab;
