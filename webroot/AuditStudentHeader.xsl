<!-- 
 ...
 $Id: //Tuxedo/RELEASE/Product/webroot/AuditStudentHeader.xsl#4 $ -->
...
<!-- CMU Locaization - add Academic Standing -->
...
<!-- End CMU Locaization - add Academic Standing -->
  </tr>
  <!-- xxxxxxxxxxx NEXT ROW xxxxxxxxxxx -->
<!-- CMU Localization - remove this row 
  <tr class="StuTableTitle">
      <td class="StuTableTitle" ><xsl:copy-of select="$vLabelLevel"/></td>
      <td class="StuTableData"  >
...
End CMU Localization - remove this row  -->
  <!-- xxxxxxxxxxx NEXT ROW xxxxxxxxxxx -->
  <tr class="StuTableTitle">
    <!-- ADVISORS -->
    <td class="StuTableTitle"  >
